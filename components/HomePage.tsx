...
const HomePage: React.FC<HomePageProps> = ({ onLogin, theme, toggleTheme }) => {
  return (
    <div className="bg-amber-50 dark:bg-gray-900">
      {/* fix: Pass isLoggedIn and onLogin props to Header to fix type error. */}
      <Header theme={theme} toggleTheme={toggleTheme} isLoggedIn={false} onLogin={onLogin} />
      <main>
        {/* Hero Section */}
        <section className="py-20 sm:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FocusXLogo className="h-20 w-auto mx-auto text-amber-600 dark:text-emerald-400" />
            ...
            <div className="mt-10">
              <button
                onClick={onLogin}
                className="px-8 py-3 text-lg font-semibold text-white bg-amber-500 rounded-lg shadow-lg hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-500 dark:focus:ring-offset-gray-900 transform hover:scale-105 transition-transform duration-300"
              >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 md:grid-cols-3 md:gap-x-12">
              <div className="flex flex-col items-center text-center">
                <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-amber-200 dark:bg-emerald-900/50 text-amber-700 dark:text-emerald-400">
      ...
      <footer id="about" className="bg-amber-100 dark:bg-gray-950">
        <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center mb-4">
            <FocusXLogo className="h-10 w-auto text-amber-600 dark:text-emerald-400" />
          </div>
